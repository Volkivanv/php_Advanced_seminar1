...
class TelegramApiImpl implements TelegramApi {
    ...
    public function getMessage(int $offset): array {
        ...
        while (true) {
            ...
            curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type:application/json')); // Set the content type to <application>
    ...
    public function sendMessage(string $chatId, string $text) {
        ...
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);//Return the respponse instead of printing it
